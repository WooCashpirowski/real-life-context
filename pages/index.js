...
export default function Home(props) {
	const { hero, about, outputs, partners, footer, ebook } = props;
	...
	return (
		<div>
			<Head>
				...
				<meta
					name='description'
					content='Learn and teach practical English'
				/>
				<meta
					name='keywords'
			...
			<Outputs locale={locale} outputs={outputs} ebook={ebook} />
...
export async function getStaticProps() {
	...
	return {
		props: {
			...
			ebook: ebookRes.items[0].fields.file.fields,
		},
		revalidate: 1,
	};
}
